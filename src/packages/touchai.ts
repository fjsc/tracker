/******************************************************************************
 * Stratio TouchAI tracker
 *
 * This file includes the crossdomain tracker code and other custom code
 * developed at Stratio
 *****************************************************************************/
...
export class Touchai {
  ...
  private _executeCrossdomainTracker(
    ...
    if (stratioCookie && stratioCookie === spUid) {
      ...
      // object.loggerDebug("Crossdomain tracker: Cookie NOT FOUND");
    } else if (stratioCookie !== spUid) {
      // object.loggerDebug("Crossdomain tracker: Cookie OUTDATED");
    }
